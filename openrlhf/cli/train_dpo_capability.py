...
from openrlhf.datasets import RewardCapabilityDataset
from openrlhf.datasets.utils import blending_datasets
from openrlhf.models import Actor
from openrlhf.trainer.dpo_capability_trainer import DPOCapabilityTrainer
...
def train(args):
    ...
    train_dataset = RewardCapabilityDataset(
        train_data,
        tokenizer,
        args.max_len,
        strategy,
